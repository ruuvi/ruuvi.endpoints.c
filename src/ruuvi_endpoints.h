...
#define RUUVI_ENDPOINT_STANDARD_LOG_VALUE_WRITE            (0x10)
#define RUUVI_ENDPOINT_STANDARD_LOG_VALUE_READ             (RUUVI_ENDPOINT_STANDARD_LOG_VALUE_WRITE | RUUVI_ENDPOINT_STANDARD_TYPE_READ_BIT)
