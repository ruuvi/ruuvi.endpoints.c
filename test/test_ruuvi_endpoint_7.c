...
static const re_7_data_t m_re_7_data_ok = { .temperature_c     = 24.3f,
                                            .humidity_rh       = 53.49f,
...
static const re_7_data_t m_re_7_data_ok_max = { .temperature_c     = 163.835f,
...
/* Minimum valid data */
/* tilt_x = -90°, tilt_y = 0° -> acc_x = -1.0, acc_y = 0.0 (device tilted fully in -X) */
static const re_7_data_t m_re_7_data_ok_min = { .temperature_c     = -163.835f,
                                                .humidity_rh       = 0.0f,
...
static const re_7_data_t m_re_7_data_invalid = { .temperature_c     = NAN,
                                                 .humidity_rh       = NAN,
                                                 .pressure_pa       = NAN,
...
static const re_7_data_t m_re_7_data_underflow = { .temperature_c     = -170.0f,
                                                   .humidity_rh       = -1.0f,
...
/* Acceleration pointing in +X direction for +90° tilt */
static const re_7_data_t m_re_7_data_overflow = { .temperature_c     = 170.0f,
                                                  .humidity_rh       = 200.0f,
 ...
 */
void
test_ruuvi_endpoint_7_encode_ok (void)
{
 ...
 */
void
test_ruuvi_endpoint_7_encode_decode_roundtrip (void)
{
    re_status_t err_code                      = RE_SUCCESS;
    uint8_t     test_buffer[RE_7_DATA_LENGTH] = { 0 };
    err_code                                  = re_7_encode (test_buffer, &m_re_7_data_ok);
    ...
    TEST_ASSERT_FLOAT_WITHIN (0.01f, m_re_7_data_ok.temperature_c,
 ...
 */
void
test_ruuvi_endpoint_7_encode_decode_max (void)
{
    re_status_t err_code                      = RE_SUCCESS;
    uint8_t     test_buffer[RE_7_DATA_LENGTH] = { 0 };
    ...
    TEST_ASSERT_FLOAT_WITHIN (1.0f, RE_7_TILT_MAX,
                              decoded_data.tilt_x_deg); /* acc_x=1 -> 90° */
    TEST_ASSERT_FLOAT_WITHIN (1.0f, 0.0f,
                              decoded_data.tilt_y_deg);         /* acc_y=0 -> 0° */
 ...
 */
void
test_ruuvi_endpoint_7_encode_decode_min (void)
{
    re_status_t err_code                      = RE_SUCCESS;
    uint8_t     test_buffer[RE_7_DATA_LENGTH] = { 0 };
    err_code                                  = re_7_encode (test_buffer,
    ...
    TEST_ASSERT_FLOAT_WITHIN (1.0f, RE_7_TILT_MIN,
                              decoded_data.tilt_x_deg); /* acc_x=-1 -> -90° */
    TEST_ASSERT_FLOAT_WITHIN (1.0f, 0.0f,
                              decoded_data.tilt_y_deg);         /* acc_y=0 -> 0° */
 ...
 */
void
test_ruuvi_endpoint_7_encode_invalid_data (void)
{
    re_status_t err_code                      = RE_SUCCESS;
    uint8_t     test_buffer[RE_7_DATA_LENGTH] = { 0 };
    err_code                                  = re_7_encode (test_buffer,
    ...
    uint16_t temp = (test_buffer[RE_7_OFFSET_TEMP_MSB] << 8) |
                    test_buffer[RE_7_OFFSET_TEMP_LSB];
    TEST_ASSERT_EQUAL_HEX16 (RE_7_INVALID_TEMPERATURE, temp);
    /* Verify invalid humidity marker */
    uint16_t humi = (test_buffer[RE_7_OFFSET_HUMI_MSB] << 8) |
                    test_buffer[RE_7_OFFSET_HUMI_LSB];
    TEST_ASSERT_EQUAL_HEX16 (RE_7_INVALID_HUMIDITY, humi);
    /* Verify invalid pressure marker */
    uint16_t pres = (test_buffer[RE_7_OFFSET_PRES_MSB] << 8) |
                    test_buffer[RE_7_OFFSET_PRES_LSB];
    TEST_ASSERT_EQUAL_HEX16 (RE_7_INVALID_PRESSURE, pres);
    /* Verify invalid luminosity marker */
    uint16_t lumi = (test_buffer[RE_7_OFFSET_LUMI_MSB] << 8) |
                    test_buffer[RE_7_OFFSET_LUMI_LSB];
 ...
 */
void
test_ruuvi_endpoint_7_decode_invalid_returns_nan (void)
{
    uint8_t test_buffer[RE_7_DATA_LENGTH] = { 0 };
 ...
 */
void
test_ruuvi_endpoint_7_encode_underflow (void)
{
    re_status_t err_code                      = RE_SUCCESS;
    uint8_t     test_buffer[RE_7_DATA_LENGTH] = { 0 };
    err_code                                  = re_7_encode (test_buffer,
 ...
 */
void
test_ruuvi_endpoint_7_encode_overflow (void)
{
    re_status_t err_code                      = RE_SUCCESS;
    uint8_t     test_buffer[RE_7_DATA_LENGTH] = { 0 };
    err_code                                  = re_7_encode (test_buffer,
 ...
 */
void
test_ruuvi_endpoint_7_encode_null_buffer (void)
{
    re_status_t    err_code      = RE_SUCCESS;
 ...
 */
void
test_ruuvi_endpoint_7_encode_null_data (void)
{
    re_status_t        err_code                      = RE_SUCCESS;
    uint8_t            test_buffer[RE_7_DATA_LENGTH] = { 0 };
 ...
 */
void
test_ruuvi_endpoint_7_decode_null_buffer (void)
{
    re_7_data_t decoded_data = { 0 };
 ...
 */
void
test_ruuvi_endpoint_7_decode_null_data (void)
{
 ...
 */
void
test_ruuvi_endpoint_7_decode_wrong_format (void)
{
    uint8_t test_buffer[RE_7_DATA_LENGTH] = { 0 };
 ...
 */
void
test_ruuvi_endpoint_7_decode_crc_error (void)
{
    uint8_t test_buffer[RE_7_DATA_LENGTH] = { 0 };
    re_7_encode (test_buffer, &m_re_7_data_ok);
    /* Corrupt the CRC */
 ...
 */
void
test_ruuvi_endpoint_7_check_format_ok (void)
{
 ...
 */
void
test_ruuvi_endpoint_7_check_format_wrong_header (void)
{
 ...
 */
void
test_ruuvi_endpoint_7_check_format_wrong_manufacturer (void)
{
 ...
 */
void
test_ruuvi_endpoint_7_check_format_wrong_length (void)
{
 ...
 */
void
test_ruuvi_endpoint_7_check_format_null (void)
{
 ...
 */
void
test_ruuvi_endpoint_7_flags_motion_only (void)
{
 ...
 */
void
test_ruuvi_endpoint_7_flags_presence_only (void)
{
    re_7_data_t data                      = m_re_7_data_ok;
 ...
 */
void
test_ruuvi_endpoint_7_flags_none (void)
{
    re_7_data_t data                      = m_re_7_data_ok;
    data.motion_detected                  = false;
    data.presence_detected                = false;
 ...
 */
void
test_ruuvi_endpoint_7_color_temp (void)
{
    re_7_data_t data = m_re_7_data_ok;
    /* Test 1000K (min) */
 ...
 */
void
test_ruuvi_endpoint_7_accel_to_tilt_flat (void)
{
    re_7_data_t data = m_re_7_data_ok;
 ...
 */
void
test_ruuvi_endpoint_7_accel_to_tilt_45deg (void)
{
    re_7_data_t data = m_re_7_data_ok;
 ...
 */
void
test_ruuvi_endpoint_7_accel_to_tilt_high_g (void)
{
    re_7_data_t data = m_re_7_data_ok;
 ...
 */
void
test_ruuvi_endpoint_7_accel_to_tilt_zero_mag (void)
{
    re_7_data_t data = m_re_7_data_ok;
 ...
 */
void
test_ruuvi_endpoint_7_accel_to_tilt_negative (void)
{
    re_7_data_t data = m_re_7_data_ok;
